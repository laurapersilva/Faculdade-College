...
public class RelacionamentoSerieAtor {
    ...
    public RelacionamentoSerieAtor(Arquivo<Serie> arqSerie, Arquivo<Ator> arqAtor) {
        ...
        try {
            ...
            for (int i = 1; i <= ultimoIdEpisodio; i++) {
                ...
                if (ep != null && ep.getSerieId() > 0) {
                    try {
                        ParIDSerieAtor par = new ParIDSerieAtor(ep.getSerieId(), ep.getId());
    ...
    public boolean adicionarRelacionamento(int idSerie, int idEpisodio) throws Exception {
        ...
        try {
            ...
            ParIDSerieAtor parBusca = new ParIDSerieAtor(idSerie, idEpisodio);
            ...
            ParIDSerieAtor par = new ParIDSerieAtor(idSerie, idEpisodio);
            ...
            while (!resultado && tentativas < 3) {
                ...
                try {
                    ...
                    if (resultado && !encontrado) {
                        ...
                        arvoreRelacionamento.create(new ParIDSerieAtor(idSerie, idEpisodio));
